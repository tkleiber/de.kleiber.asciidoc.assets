...
chalkboard: { 
	...
	background: [ 'rgba(141,191,68,.1)', 'assets/vendor/revealjs/revealjs-plugins/chalkboard/img/blackboard.png' ] // The first value expects a (semi-)transparent color which is used to provide visual feedback that the notes canvas is enabled, the second value expects a filename to a background image for the chalkboard.
},
//
...
menu: {
	...
	custom: [ { title: 'Keys', icon: '<i class="fa fa-keyboard">', content: `
  	...
  	themes: [// Specifies the themes that will be available in the themes menu panel. Set to 'true' to show the themes menu panel with the default themes list. 
		{ name: '########## light ##########', theme: 'themes/css/reveal-tkleiber-light.css' },
		{ name: 'tkleiber-light-agile', theme: 'themes/css/reveal-tkleiber-light-agile.css' },
		{ name: '########## dark ##########', theme: 'themes/css/reveal-tkleiber-dark.css' },
		{ name: 'tkleiber-dark-agile', theme: 'themes/css/reveal-tkleiber-dark-agile.css' }]
}